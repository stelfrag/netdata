...
void journalfile_v2_data_set(struct rrdengine_journalfile *journalfile, int fd, void *journal_data, struct journal_v2_header *j2_header_only, uint32_t journal_data_size, bool file_in_snapshot);
