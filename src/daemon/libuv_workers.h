...
enum event_loop_job {
    ...
    UV_EVENT_HOST_CALC_CLEANUP,

    UV_EVENT_HEALTH_JOB_RRD_LOCK,
    UV_EVENT_HEALTH_JOB_HOST_LOCK,
    UV_EVENT_HEALTH_JOB_DB_QUERY,
    UV_EVENT_HEALTH_JOB_CALC_EVAL,
    UV_EVENT_HEALTH_JOB_WARNING_EVAL,
    UV_EVENT_HEALTH_JOB_CRITICAL_EVAL,
    UV_EVENT_HEALTH_JOB_ALARM_LOG_ENTRY,
    UV_EVENT_HEALTH_JOB_ALARM_LOG_PROCESS,
    UV_EVENT_HEALTH_JOB_ALARM_LOG_QUEUE,
    UV_EVENT_HEALTH_JOB_WAIT_EXEC,
    UV_EVENT_HEALTH_JOB_DELAYED_INIT_RRDSET,
    UV_EVENT_HEALTH_JOB_DELAYED_INIT_RRDDIM,
